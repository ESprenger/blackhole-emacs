;;; +org-todo.el --- Description -*- no-byte-compile: t; lexical-binding: t; -*-
;;
...
;;;###autoload
(defun my/org-todo-next () (interactive) (my/org--ensure) (org-todo "NEXT"))  ;; [Manual: TODO state change][web:20]
;;;###autoload
(defun my/org-todo-in-progress () (interactive) (my/org--ensure) (org-todo "IN-PROGRESS"))  ;; [Manual: TODO state change][web:20]
;;;###autoload
(defun my/org-todo-waiting () (interactive) (my/org--ensure) (org-todo "WAITING"))  ;; [Manual: TODO state change][web:20]
;;;###autoload
(defun my/org-todo-done () (interactive) (my/org--ensure) (org-todo "DONE"))  ;; [Manual: TODO state change][web:20]
;;;###autoload
(defun my/org-todo-cancel () (interactive) (my/org--ensure) (org-todo "CANCELLED"))  ;; [Manual: TODO state change][web:20]

;; When clocking in, mark IN-PROGRESS
(defun my/org-clock-in-set-next ()
...
(add-hook 'org-clock-in-hook #'my/org-clock-in-set-next)  ;; [Manual hooks][web:16]

;; Auto-update parent state based on children; requires a statistics cookie
(defun my/org-update-parent-todo (n-done n-not-done)
...
(add-hook 'org-after-todo-statistics-hook #'my/org-update-parent-todo)  ;; [Manual: org-after-todo-statistics-hook][web:16][web:13]
