;;; +org-capture.el --- Description -*- no-byte-compile: t; lexical-binding: t; -*-
;;
...
;; -------------------------------
(defvar my/org-dir (or (bound-and-true-p org-directory) "~/Documents/org")
...
;; Quick file opener
(defun my/open-capture-file (file)
...
;; (global-set-key (kbd "C-c o f") #'my/open-capture-file)
